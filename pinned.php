...
// List all snippets
$query_pinned = 'SELECT * FROM snippets
                 ORDER BY snippet_id';

$db_list_query = $db->prepare($query_pinned);
...
<body>
    <div id="nav">
        ...
        <span>
            <a id="nav-controls" href="pinsnippet.php">Unpin Snippet</a>
        </span>
    </div>
                    ...
                    <form action="editsnippet.php" method="post">    
                        <table>
                            <tr>
                                ...
                                <td>
                                    <input class="item-selection" type="submit" name="edit_pinned" value="Edit">
                                </td>
                                <td>
                                    <input class="item-selection" type="submit" name="delete_pinned" value="Delete">
                                </td>
                                <td>
                                    <input class="item-selection" type="submit" name="pinstatus_unpin" value="Unpin">
                                </td>
                            </tr>
                        </table>
                    </form>
